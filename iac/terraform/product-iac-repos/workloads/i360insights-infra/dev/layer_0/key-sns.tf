    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::004802276251:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::004802276251:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "004802276251"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "004802276251"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::004802276251:*",
                        "arn:aws:cloudwatch:ca-central-1:004802276251:*",
                        "arn:aws:events:ca-central-1:004802276251:*",
                        "arn:aws:sns:ca-central-1:004802276251:*"
                    ]
                }
            }
        }
