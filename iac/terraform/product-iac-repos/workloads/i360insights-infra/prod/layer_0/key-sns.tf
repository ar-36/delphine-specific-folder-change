    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::744659032260:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::744659032260:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "744659032260"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "744659032260"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::744659032260:*",
                        "arn:aws:cloudwatch:ca-central-1:744659032260:*",
                        "arn:aws:events:ca-central-1:744659032260:*",
                        "arn:aws:sns:ca-central-1:744659032260:*"
                    ]
                }
            }
        }
