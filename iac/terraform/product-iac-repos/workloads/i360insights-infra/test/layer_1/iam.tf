...
data "aws_iam_policy_document" "gha" {
  statement {
    ...
    principals {
      identifiers = ["arn:aws:iam::527351886011:oidc-provider/token.actions.githubusercontent.com"]
      type        = "Federated"
    }
...
resource "aws_iam_role" "gha" {
  ...
  name                 = "iep-i360insights-infra-test-gha-exec"
  path                 = "/"
  ...
  # permissions_boundary = aws_iam_policy.i360insights-infra_test_role_permission_boundary.arn
