    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::527351886011:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::527351886011:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "527351886011"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "527351886011"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::527351886011:*",
                        "arn:aws:cloudwatch:ca-central-1:527351886011:*",
                        "arn:aws:events:ca-central-1:527351886011:*",
                        "arn:aws:sns:ca-central-1:527351886011:*"
                    ]
                }
            }
        }
