...
data "aws_iam_policy_document" "gha" {
  statement {
    ...
    principals {
      identifiers = ["arn:aws:iam::891377037249:oidc-provider/token.actions.githubusercontent.com"]
      type        = "Federated"
    }
    ...
    condition {
      ...
      values = [
        "repo:CPC-SCP/edapa-adv-analy-ent-forecasting:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-workflow.yml@refs/heads/*",
        "repo:CPC-SCP/edapa-adv-analy-ent-forecasting:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-force-unlock.yml@refs/heads/*",
      ]
    }
  }
}
...
resource "aws_iam_role" "gha" {
  ...
  name                 = "iep-edapa-adv-analy-ent-forecasting-prod-gha-exec"
  path                 = "/"
  ...
  # permissions_boundary = aws_iam_policy.edapa-adv-analy-ent-forecasting_prod_role_permission_boundary.arn
