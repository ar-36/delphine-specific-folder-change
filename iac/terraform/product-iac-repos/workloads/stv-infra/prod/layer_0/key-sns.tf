    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::899633399379:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::899633399379:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "899633399379"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "899633399379"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::899633399379:*",
                        "arn:aws:cloudwatch:ca-central-1:899633399379:*",
                        "arn:aws:events:ca-central-1:899633399379:*",
                        "arn:aws:sns:ca-central-1:899633399379:*"
                    ]
                }
            }
        }
