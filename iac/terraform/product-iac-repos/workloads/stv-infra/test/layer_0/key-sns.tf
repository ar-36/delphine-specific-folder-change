    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::167884296981:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::167884296981:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "167884296981"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "167884296981"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::167884296981:*",
                        "arn:aws:cloudwatch:ca-central-1:167884296981:*",
                        "arn:aws:events:ca-central-1:167884296981:*",
                        "arn:aws:sns:ca-central-1:167884296981:*"
                    ]
                }
            }
        }
