    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::219780354720:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::219780354720:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "219780354720"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "219780354720"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::219780354720:*",
                        "arn:aws:cloudwatch:ca-central-1:219780354720:*",
                        "arn:aws:events:ca-central-1:219780354720:*",
                        "arn:aws:sns:ca-central-1:219780354720:*"
                    ]
                }
            }
        }
