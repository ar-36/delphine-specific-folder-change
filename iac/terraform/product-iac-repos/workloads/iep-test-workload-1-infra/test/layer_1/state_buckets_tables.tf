...
resource "aws_dynamodb_table" "state" {
  ...
  name         = "iep-test-workload-1-infra-test-tf-locking"
...
resource "aws_s3_bucket" "state" {
  ...
  bucket = "test-1-test-tf-state-884561156600-ca-central-1"

  tags = {
    Name = "test-1-test-tf-state-884561156600-ca-central-1"
  }
...
resource "aws_s3_bucket_logging" "state" {
  ...
  target_bucket = "aws-accelerator-s3-access-logs-884561156600-ca-central-1"
  target_prefix = "test-1-test-tf-state-884561156600-ca-central-1/"
