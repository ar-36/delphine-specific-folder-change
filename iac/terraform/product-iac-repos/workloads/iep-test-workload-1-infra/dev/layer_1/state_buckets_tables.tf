...
resource "aws_dynamodb_table" "state" {
  ...
  name         = "iep-test-workload-1-infra-dev-tf-locking"
...
resource "aws_s3_bucket" "state" {
  ...
  bucket = "test-1-dev-tf-state-482699811241-ca-central-1"

  tags = {
    Name = "test-1-dev-tf-state-482699811241-ca-central-1"
  }
...
resource "aws_s3_bucket_logging" "state" {
  ...
  target_bucket = "aws-accelerator-s3-access-logs-482699811241-ca-central-1"
  target_prefix = "test-1-dev-tf-state-482699811241-ca-central-1/"
