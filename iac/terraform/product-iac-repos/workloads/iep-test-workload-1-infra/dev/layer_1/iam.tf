...
data "aws_iam_policy_document" "gha" {
  statement {
    ...
    principals {
      identifiers = ["arn:aws:iam::482699811241:oidc-provider/token.actions.githubusercontent.com"]
      type        = "Federated"
    }
    ...
    condition {
      ...
      values = [
        "repo:CPC-SCP/iep-test-workload-1-infra:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-workflow.yml@refs/heads/*",
        "repo:CPC-SCP/iep-test-workload-1-infra:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-force-unlock.yml@refs/heads/*",

        "repo:CPC-SCP/iep-test-workload-1-infra:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-destroy.yml@refs/heads/*",
      ]
    }
  }
}
...
data "aws_iam_policy_document" "permissions_boundary" {
  ...
  statement {
    ...
    condition {
      ...
      values   = ["arn:aws:iam::482699811241:role/iep-test-workload-1-infra-terraform-module-ci-exec"]
    }
  }
...
resource "aws_iam_role" "gha" {
  ...
  name                 = "iep-test-workload-1-infra-dev-gha-exec"
  path                 = "/"
  ...
  # permissions_boundary = aws_iam_policy.iep-test-workload-1-infra_dev_role_permission_boundary.arn
...
data "aws_iam_policy_document" "terraform_module_ci" {
  statement {
    ...
    condition {
      test     = "StringLike"
      values   = ["repo:CPC-SCP/terraform-aws-*:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-module-ci.yaml@refs/heads/*"]
      variable = "token.actions.githubusercontent.com:sub"
    }
  }
}
...
resource "aws_iam_role" "terraform_module_ci" {
  ...
  max_session_duration = 7200
  name                 = "iep-test-workload-1-infra-terraform-module-ci-exec"
  path                 = "/"
