  ...
  key_policy  = <<EOT
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "482699811241"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::482699811241:*",
                        "arn:aws:cloudwatch:ca-central-1:482699811241:*",
                        "arn:aws:events:ca-central-1:482699811241:*",
                        "arn:aws:sns:ca-central-1:482699811241:*"
                    ]
                }
            }
        }
