...
locals {
  selected_base_domains = { "canada_post-external" : "false", "canada_post-internal" : "false", "canada_post-private" : "false", "innovapost-external" : "false", "innovapost-internal" : "false", "innovapost-private" : "false", "shared-internal" : "false", "shared-private" : "false" }
    ...
    payload = jsonencode(
      {
        ...
        path = "phz/authorizations/632860535475.json"
      }
    )
    }
  )
