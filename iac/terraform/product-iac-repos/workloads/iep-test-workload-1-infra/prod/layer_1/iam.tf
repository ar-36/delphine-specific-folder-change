...
data "aws_iam_policy_document" "gha" {
  statement {
    ...
    principals {
      identifiers = ["arn:aws:iam::632860535475:oidc-provider/token.actions.githubusercontent.com"]
      type        = "Federated"
    }
...
data "aws_iam_policy_document" "permissions_boundary" {
  ...
  statement {
    ...
    condition {
      ...
      values   = ["arn:aws:iam::632860535475:role/iep-test-workload-1-infra-terraform-module-ci-exec"]
    }
...
resource "aws_iam_role" "gha" {
  ...
  name                 = "iep-test-workload-1-infra-prod-gha-exec"
  path                 = "/"
  ...
  # permissions_boundary = aws_iam_policy.iep-test-workload-1-infra_prod_role_permission_boundary.arn
