...
module "github_repo" {
  ...
  homepage_url             = ""
  is_template              = false
  repo_name                = "edap-governance-infra"
...
resource "github_actions_repository_oidc_subject_claim_customization_template" "main" {
  ...
  provider           = github
  repository         = "edap-governance-infra"
  use_default        = false
}
