...
data "aws_iam_policy_document" "gha" {
  statement {
    ...
    principals {
      identifiers = ["arn:aws:iam::416446934920:oidc-provider/token.actions.githubusercontent.com"]
      type        = "Federated"
    }
...
resource "aws_iam_role" "gha" {
  ...
  name                 = "iep-edap-governance-infra-prod-gha-exec"
  path                 = "/"
  ...
  # permissions_boundary = aws_iam_policy.edap-governance-infra_prod_role_permission_boundary.arn
