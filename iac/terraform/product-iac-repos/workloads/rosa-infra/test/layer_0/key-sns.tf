    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::276378825251:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::276378825251:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "276378825251"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "276378825251"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::276378825251:*",
                        "arn:aws:cloudwatch:ca-central-1:276378825251:*",
                        "arn:aws:events:ca-central-1:276378825251:*",
                        "arn:aws:sns:ca-central-1:276378825251:*"
                    ]
                }
            }
        }
