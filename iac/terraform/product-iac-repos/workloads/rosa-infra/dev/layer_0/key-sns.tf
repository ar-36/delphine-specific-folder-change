    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::035426313441:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::035426313441:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "035426313441"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "035426313441"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::035426313441:*",
                        "arn:aws:cloudwatch:ca-central-1:035426313441:*",
                        "arn:aws:events:ca-central-1:035426313441:*",
                        "arn:aws:sns:ca-central-1:035426313441:*"
                    ]
                }
            }
        }
