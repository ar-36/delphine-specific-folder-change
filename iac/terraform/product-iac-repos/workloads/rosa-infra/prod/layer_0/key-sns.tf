    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::410692821451:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::410692821451:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "410692821451"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "410692821451"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::410692821451:*",
                        "arn:aws:cloudwatch:ca-central-1:410692821451:*",
                        "arn:aws:events:ca-central-1:410692821451:*",
                        "arn:aws:sns:ca-central-1:410692821451:*"
                    ]
                }
            }
        }
