...
data "aws_iam_policy_document" "gha" {
  statement {
    ...
    principals {
      identifiers = ["arn:aws:iam::606096854338:oidc-provider/token.actions.githubusercontent.com"]
      type        = "Federated"
    }
...
resource "aws_iam_role" "gha" {
  ...
  name                 = "iep-edap-raw-infra-test-gha-exec"
  path                 = "/"
  ...
  # permissions_boundary = aws_iam_policy.edap-raw-infra_test_role_permission_boundary.arn
