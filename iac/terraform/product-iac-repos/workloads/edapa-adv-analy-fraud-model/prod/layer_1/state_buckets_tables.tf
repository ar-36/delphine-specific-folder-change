...
resource "aws_dynamodb_table" "state" {
  ...
  name         = "edapa-adv-analy-fraud-model-prod-tf-locking"
...
resource "aws_s3_bucket" "state" {
  ...
  bucket = "edapa-fraud-model-prod-tf-state-211125395163-ca-central-1"

  tags = {
    Name = "edapa-fraud-model-prod-tf-state-211125395163-ca-central-1"
  }
...
resource "aws_s3_bucket_logging" "state" {
  ...
  target_bucket = "aws-accelerator-s3-access-logs-211125395163-ca-central-1"
  target_prefix = "edapa-fraud-model-prod-tf-state-211125395163-ca-central-1/"
