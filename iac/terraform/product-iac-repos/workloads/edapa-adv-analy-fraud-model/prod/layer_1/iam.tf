...
data "aws_iam_policy_document" "gha" {
  statement {
    ...
    principals {
      identifiers = ["arn:aws:iam::211125395163:oidc-provider/token.actions.githubusercontent.com"]
      type        = "Federated"
    }
    ...
    condition {
      ...
      values = [
        "repo:CPC-SCP/edapa-adv-analy-fraud-model:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-workflow.yml@refs/heads/*",
        "repo:CPC-SCP/edapa-adv-analy-fraud-model:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-force-unlock.yml@refs/heads/*",
      ]
    }
  }
}
...
resource "aws_iam_role" "gha" {
  ...
  name                 = "iep-edapa-adv-analy-fraud-model-prod-gha-exec"
  path                 = "/"
  ...
  # permissions_boundary = aws_iam_policy.edapa-adv-analy-fraud-model_prod_role_permission_boundary.arn
