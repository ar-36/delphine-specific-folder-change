...
data "aws_iam_policy_document" "gha" {
  statement {
    ...
    principals {
      identifiers = ["arn:aws:iam::891377138205:oidc-provider/token.actions.githubusercontent.com"]
      type        = "Federated"
    }
    ...
    condition {
      ...
      values = [
        "repo:CPC-SCP/ACEPoc-infra:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-workflow.yml@refs/heads/*",
        "repo:CPC-SCP/ACEPoc-infra:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-force-unlock.yml@refs/heads/*",

        "repo:CPC-SCP/ACEPoc-infra:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-destroy.yml@refs/heads/*",
      ]
    }
  }
}
...
resource "aws_iam_role" "gha" {
  ...
  # permissions_boundary = aws_iam_policy.ACEPoc-infra_dev_role_permission_boundary.arn
