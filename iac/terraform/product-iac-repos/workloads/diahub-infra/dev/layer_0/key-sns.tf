  ...
  key_policy  = <<EOT
{
    ...
    "Statement": [
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "725134211203"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::725134211203:*",
                        "arn:aws:cloudwatch:ca-central-1:725134211203:*",
                        "arn:aws:events:ca-central-1:725134211203:*",
                        "arn:aws:sns:ca-central-1:725134211203:*"
                    ]
                }
            }
        }
