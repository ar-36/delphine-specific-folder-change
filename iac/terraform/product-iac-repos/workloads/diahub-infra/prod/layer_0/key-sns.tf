    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::993638785291:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::993638785291:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "993638785291"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "993638785291"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::993638785291:*",
                        "arn:aws:cloudwatch:ca-central-1:993638785291:*",
                        "arn:aws:events:ca-central-1:993638785291:*",
                        "arn:aws:sns:ca-central-1:993638785291:*"
                    ]
                }
            }
        }
