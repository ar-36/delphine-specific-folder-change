    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::713208680458:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::713208680458:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "713208680458"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Condition": {
                "StringEquals": {
                    "aws:SourceAccount": "713208680458"
                },
                "ArnLike": {
                    "aws:SourceArn": [
                        "arn:aws:budgets::713208680458:*",
                        "arn:aws:cloudwatch:ca-central-1:713208680458:*",
                        "arn:aws:events:ca-central-1:713208680458:*",
                        "arn:aws:sns:ca-central-1:713208680458:*"
                    ]
                }
            }
        }
