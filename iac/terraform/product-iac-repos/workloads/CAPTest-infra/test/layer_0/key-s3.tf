    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::211125654669:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::211125654669:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "211125654669"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Effect": "Deny",
            "Principal": {
                "AWS": "arn:aws:iam::485049259865:role/edap-gov-test-datamesh-role"
            },
            "Action": [
                "kms:Encrypt",
                "kms:Decrypt",
