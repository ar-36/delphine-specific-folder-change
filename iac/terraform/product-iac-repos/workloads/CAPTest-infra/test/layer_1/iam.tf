...
data "aws_iam_policy_document" "gha" {
  statement {
    ...
    principals {
      identifiers = ["arn:aws:iam::211125654669:oidc-provider/token.actions.githubusercontent.com"]
      type        = "Federated"
    }
...
resource "aws_iam_role" "gha" {
  ...
  name                 = "iep-CAPTest-infra-test-gha-exec"
  path                 = "/"
  ...
  # permissions_boundary = aws_iam_policy.CAPTest-infra_test_role_permission_boundary.arn
