...
data "aws_iam_policy_document" "gha" {
  statement {
    ...
    principals {
      identifiers = ["arn:aws:iam::730335578993:oidc-provider/token.actions.githubusercontent.com"]
      type        = "Federated"
    }
...
resource "aws_iam_role" "gha" {
  ...
  name                 = "iep-CAPTest-infra-prod-gha-exec"
  path                 = "/"
  ...
  # permissions_boundary = aws_iam_policy.CAPTest-infra_prod_role_permission_boundary.arn
