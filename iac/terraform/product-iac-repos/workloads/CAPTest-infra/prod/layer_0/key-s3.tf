    ...
    "Statement": [
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::730335578993:role/iep-provisioner-gha-exec"
            },
            "Action": [
                "kms:*"
            ],
        ...
        },
        {
            ...
            "Effect": "Allow",
            "Principal": {
                "AWS": "arn:aws:iam::730335578993:root"
            },
            "Action": [
                "kms:Describe*",
                "kms:Get*",
            ...
            "Condition": {
                "StringEquals": {
                    "kms:CallerAccount": "730335578993"
                }
            }
        },
        {
        ...
        },
        {
            ...
            "Effect": "Deny",
            "Principal": {
                "AWS": "arn:aws:iam::416446934920:role/edap-gov-prod-datamesh-role"
            },
            "Action": [
                "kms:Encrypt",
                "kms:Decrypt",
