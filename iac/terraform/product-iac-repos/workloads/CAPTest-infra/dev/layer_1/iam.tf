...
data "aws_iam_policy_document" "gha" {
  statement {
    ...
    principals {
      identifiers = ["arn:aws:iam::851725380142:oidc-provider/token.actions.githubusercontent.com"]
      type        = "Federated"
    }
    ...
    condition {
      ...
      values = [
        "repo:CPC-SCP/CAPTest-infra:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-workflow.yml@refs/heads/*",
        "repo:CPC-SCP/CAPTest-infra:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-force-unlock.yml@refs/heads/*",

        "repo:CPC-SCP/CAPTest-infra:job_workflow_ref:CPC-SCP/iep-reusable-gha-workflows/.github/workflows/terraform-destroy.yml@refs/heads/*",
      ]
    }
  }
}
...
resource "aws_iam_role" "gha" {
  ...
  name                 = "iep-CAPTest-infra-dev-gha-exec"
  path                 = "/"
  ...
  # permissions_boundary = aws_iam_policy.CAPTest-infra_dev_role_permission_boundary.arn
