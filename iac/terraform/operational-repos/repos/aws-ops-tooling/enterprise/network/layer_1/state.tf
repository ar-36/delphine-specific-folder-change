...
resource "aws_dynamodb_table" "state" {
  ...
  hash_key     = "LockID"
  name         = "aws-ops-tooling-network-tf-locking"
...
resource "aws_s3_bucket" "state" {
  ...
  bucket = "aws-ops-tooling-tf-state-042224974909-ca-central-1"

  tags = {
    Name = "aws-ops-tooling-tf-state-042224974909-ca-central-1"
  }
...
resource "aws_s3_bucket_logging" "state" {
  ...
  target_bucket = "aws-accelerator-s3-access-logs-042224974909-ca-central-1"
  target_prefix = "aws-ops-tooling-tf-state-042224974909-ca-central-1/"
