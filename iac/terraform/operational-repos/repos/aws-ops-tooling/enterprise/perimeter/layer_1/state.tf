...
resource "aws_s3_bucket" "state" {
  ...
  bucket = "aws-ops-tooling-tf-state-481709940714-ca-central-1"

  tags = {
    Name = "aws-ops-tooling-tf-state-481709940714-ca-central-1"
  }
...
resource "aws_s3_bucket_logging" "state" {
  ...
  target_bucket = "aws-accelerator-s3-access-logs-481709940714-ca-central-1"
  target_prefix = "aws-ops-tooling-tf-state-481709940714-ca-central-1/"
